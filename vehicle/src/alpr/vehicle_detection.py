...
def extract_car(frame):
  # path="alpr/alpr_data/vehicle-detector/yolo-coco/coco.names"
  print(os.getcwd())
  ...
  # weightsPath="alpr/alpr_data/vehicle-detector/yolo-coco/yolov3.weights"
  # configPath ="alpr/alpr_data/vehicle-detector/yolo-coco/yolov3.cfg"
